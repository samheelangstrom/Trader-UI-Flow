...
import { Bell, ArrowLeft, MoreHorizontal, X } from "lucide-react"

export default function AlertsPage() {
  const [activeTab, setActiveTab] = useState("MLB")

  // Sample alert data with severity levels
  const alerts = [
    {
      id: 1,
      market: "Money Line",
  ...
  // Add state for the alert details modal
  ...
  return (
    <div className="bg-[#fafafa] min-h-screen text-[#2b2c2d]">
      {/* Top Navigation */}
      <div className="flex items-center justify-between border-b border-[#dcdddf] px-4 py-3 bg-white">
        <div className="flex items-center gap-4">
          ...
          <div
            className={`relative font-medium cursor-pointer ${activeTab === "MLB" ? "text-[#eb6a2e]" : ""}`}
          ...
          <div
            className={`relative font-medium cursor-pointer ${activeTab === "NBA" ? "text-[#eb6a2e]" : ""}`}
